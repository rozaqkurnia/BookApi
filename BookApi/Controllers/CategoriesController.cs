...
namespace BookApi.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            var categories = _categoryRepository.GetCategoies().ToList();
        ...
        public IActionResult CreateCategory([FromBody]Category categoryToCreate)
        {
            ...
            var category = _categoryRepository.GetCategoies()
        ...
        public IActionResult UpdateCategory(int categoryId,[FromBody]Category updatedCategoryInfo)
        {
            ...
            {
                ModelState.AddModelError("", $"Somethinf went wrong saving {updatedCategoryInfo.Name}.");
                return StatusCode(500, ModelState);
            }
