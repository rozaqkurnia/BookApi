...
namespace BookApi.Services
{
    public class BookRepository : IBookRepository
    {
        ...
        {
            var authors = _bookDbContext.Authors
                .Where(a => authorsId.Contains(a.Id))
                .ToList();

            var categories = _bookDbContext.Categories
        ...
        {
            var reviews = _bookDbContext.Reviews
        ...
        public bool UpdateBook(List<int> authorsId, List<int> categoriesId, Book book)
        {
            ...
            var bookAuthorsToDelete = _bookDbContext.BookAuthors
                .Where(b => b.BookId == book.Id);

            var bookCategoriesToDelete = _bookDbContext.BookCategories
                .Where(b => b.BookId == book.Id);
